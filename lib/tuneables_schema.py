...
SCHEMA: Dict[str, Dict[str, TuneableSpec]] = {
    ...
    "retrieval": {
        ...
        "include_bank_advice": TuneableSpec("bool", False, None, None, "Include memory-bank advice source"),
        "include_tool_specific_advice": TuneableSpec("bool", False, None, None, "Include tool-specific self-awareness source"),
        "semantic_use_embeddings": TuneableSpec("bool", False, None, None, "Use embedding model for semantic retrieval"),
    ...
    "sync": {
        ...
        "compaction_enabled": TuneableSpec("bool", True, None, None, "Enable periodic unified compaction during sync"),
        "compaction_cooldown_s": TuneableSpec("int", 21600, 300, 604800, "Cooldown between unified compaction runs (s)"),
        "compaction_max_actions": TuneableSpec("int", 24, 0, 1000, "Global action budget per compaction cycle across cognitive + packet stores"),
        "cognitive_actr_enabled": TuneableSpec("bool", True, None, None, "Enable ACT-R style cognitive compaction lane during sync"),
        "cognitive_actr_max_age_days": TuneableSpec("float", 180.0, 30.0, 3650.0, "Minimum memory age for cognitive stale deletion candidates"),
        "cognitive_actr_min_activation": TuneableSpec("float", 0.20, 0.01, 1.0, "Activation threshold for cognitive stale deletion candidates"),
        "cognitive_actr_max_deletes": TuneableSpec("int", 20, 0, 500, "Max cognitive deletions applied per compaction cycle"),
