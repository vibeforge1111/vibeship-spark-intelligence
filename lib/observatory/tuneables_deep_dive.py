...
KNOWN_RELOAD_SECTIONS = {
    ...
    "advisory_quality": ["lib/preferences.py"],
    "advisor": ["lib/advisor.py", "lib/preferences.py"],
...
def generate_tuneables_deep_dive(data: Dict[int, Dict[str, Any]]) -> str:
    ...
    lines.append("| 8. Pre-tool orchestrator | `advisory_engine` | `include_mind`, prefetch controls, `global_dedupe_*`, synth controls |")
