...
def generate_flow_dashboard(data: dict[int, dict[str, Any]]) -> str:
    ...
    sections.append("- [[advisory_content_quality_forensics|Advisory Content Quality Forensics]] - production noise recall, false positives, and 100s of detailed content rows")
    sections.append("- [[intelligence_constitution|Intelligence Constitution]] - non-negotiable invariants for memory and advisory quality")
