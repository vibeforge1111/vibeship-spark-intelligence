# Alpha Deep System Audit (2026-02-27T21:11:46.289932Z)
...
- (9) lib.chip_merger, lib.cognitive_learner, lib.eidos.store, lib.memory_banks, lib.meta_ralph, lib.project_profile, lib.promoter, lib.semantic_retriever, lib.validate_and_store
...
adapters/codex_hook_bridge.py - degraded
  - Issues: oversized:1217, long_func:201, lint_top:I001:1
  - Migration needed: no
  - Priority: high
  - Dependencies: relied_by=[none] | relies_on=[none]
...
docs/SPARK_ALPHA_REDUCTION_WAVES_PLAN.md - healthy
  ...
  - Priority: low
  - Dependencies: relied_by=[none] | relies_on=[none]
docs/SPARK_ALPHA_RUNTIME_CONTRACT.md - needs-migration
  - Issues: missing_code_refs:1
  - Migration needed: yes
  - Priority: medium
  - Dependencies: relied_by=[none] | relies_on=[none]
...
hooks/observe.py - degraded
  - Issues: lint_density:37, oversized:1359, lint_top:W293:25,I001:7,F401:4
  - Migration needed: no
  - Priority: high
  - Dependencies: relied_by=[scripts.spark_sandbox] | relies_on=[none]
install.ps1 - healthy
  - Issues: none
  - Migration needed: no
  - Priority: low
...
lib/advice_feedback.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.advisor, scripts.advisory_day_trial, scripts.advisory_tag_outcome, tests.test_advice_feedback_correlation] | relies_on=[lib.diagnostics, lib.file_lock]
lib/advisor.py - degraded
  - Issues: oversized:6136, long_func:442, lint_top:I001:1
  - Migration needed: no
  - Priority: high
  - Dependencies: relied_by=[lib.advisory_engine_alpha, lib.bridge, lib.preferences, lib.production_gates, scripts.advise_act, scripts.edge_case_harness] | relies_on=[lib.advice_feedback, lib.advisory_synthesizer, lib.aha_tracker, lib.cognitive_learner, lib.config_authority, lib.convo_analyzer]
lib/advisory_engine_alpha.py - degraded
  - Issues: long_func:266, lint_top:I001:2
  - Migration needed: no
  - Priority: high
  - Dependencies: relied_by=[lib.preferences, scripts.spark_alpha_replay_arena, sparkd, tests.test_advisory_engine_alpha, tests.test_advisory_orchestrator, tests.test_advisory_preferences] | relies_on=[lib.advisor, lib.advisory_gate, lib.advisory_packet_store, lib.advisory_synthesizer, lib.cognitive_learner, lib.config_authority]
...
lib/aha_tracker.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.advisor, lib.bridge, lib.prediction_loop, lib.resonance, lib.validation_loop] | relies_on=[none]
lib/auto_promote.py - healthy
  - Issues: none
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[tests.test_promotion_config_authority] | relies_on=[lib.config_authority, lib.diagnostics, lib.promoter, lib.tuneables_reload]
...
lib/bridge.py - degraded
  ...
  - Migration needed: no
  - Priority: high
  - Dependencies: relied_by=[lib.bridge_cycle, scripts.mem_profile2, scripts.mem_profile3, tests.test_bridge_context_sources] | relies_on=[lib.advisor, lib.aha_tracker, lib.cognitive_learner, lib.config_authority, lib.diagnostics, lib.exposure_tracker]
lib/bridge_cycle.py - degraded
  - Issues: oversized:1431, long_func:630, lint_top:I001:1
  - Migration needed: no
  - Priority: high
  - Dependencies: relied_by=[bridge_worker, lib.doctor, lib.output_adapters.openclaw, lib.service_control, scripts.mem_profile, scripts.spark_sandbox] | relies_on=[lib.auto_tuner, lib.bridge, lib.chip_merger, lib.cognitive_learner, lib.cognitive_signals, lib.config_authority]
...
lib/chip_merger.py - needs-migration
  - Issues: circular_dependency, lint_top:I001:2
  - Migration needed: yes
  - Priority: high
  - Dependencies: relied_by=[lib.bridge_cycle, lib.promoter, scripts.mem_profile3, tests.test_chips_quality_integration, tests.test_remaining_config_authority] | relies_on=[lib.cognitive_learner, lib.config_authority, lib.exposure_tracker, lib.queue, lib.tuneables_reload, lib.validate_and_store]
...
lib/cognitive_learner.py - degraded
  - Issues: oversized:2324, long_func:411, circular_dependency, lint_top:I001:1
  - Migration needed: yes
  - Priority: high
  - Dependencies: relied_by=[lib.advisor, lib.advisory_engine_alpha, lib.bridge, lib.bridge_cycle, lib.chip_merger, lib.cognitive_signals] | relies_on=[lib.config_authority, lib.context_envelope, lib.distillation_transformer, lib.exposure_tracker, lib.feature_flags, lib.llm_area_prompts]
lib/cognitive_signals.py - healthy
  - Issues: lint_top:F401:2
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.bridge_cycle, tests.test_10_improvements] | relies_on=[lib.cognitive_learner, lib.diagnostics, lib.importance_scorer, lib.validate_and_store]
lib/config_authority.py - healthy
  - Issues: none
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[adapters.openclaw_tailer, lib.advisor, lib.advisory_engine_alpha, lib.advisory_gate, lib.advisory_packet_store, lib.advisory_synthesizer] | relies_on=[lib.tuneables_schema]
...
lib/curiosity_engine.py - degraded
  - Issues: lint_issues:13, runtime_orphan, lint_top:E402:8,I001:3,F401:1
  - Migration needed: no
  - Priority: medium
  - Dependencies: relied_by=[none] | relies_on=[lib.cognitive_learner, lib.validate_and_store]
...
lib/diagnostics.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[bridge_worker, lib.advice_feedback, lib.advisory_engine_alpha, lib.advisory_synthesizer, lib.auto_promote, lib.bridge] | relies_on=[none]
...
lib/eidos/integration.py - degraded
  - Issues: lint_issues:13, long_func:145, runtime_orphan, lint_top:F401:11,I001:1,F541:1
  - Migration needed: no
  - Priority: high
  - Dependencies: relied_by=[none] | relies_on=[lib.eidos.control_plane, lib.eidos.distillation_engine, lib.eidos.elevated_control, lib.eidos.escalation, lib.eidos.evidence_store, lib.eidos.guardrails]
...
lib/eidos/models.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.depth_trainer, lib.eidos.acceptance_compiler, lib.eidos.control_plane, lib.eidos.elevated_control, lib.eidos.escalation, lib.eidos.guardrails] | relies_on=[lib.config_authority, lib.tuneables_reload]
...
lib/eidos/store.py - degraded
  - Issues: oversized:1365, long_func:143, circular_dependency, lint_top:I001:1,F841:1
  - Migration needed: yes
  - Priority: high
  - Dependencies: relied_by=[lib.advisor, lib.bridge_cycle, lib.eidos.elevated_control, lib.eidos.evidence_store, lib.eidos.integration, lib.eidos.migration] | relies_on=[lib.distillation_transformer, lib.eidos.models, lib.eidos_refiner, lib.primitive_filter, lib.promoter]
...
lib/embeddings.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.contradiction_detector, lib.importance_scorer, lib.memory_store, lib.prediction_loop, lib.semantic_retriever] | relies_on=[none]
...
lib/feedback.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[tests.test_feedback] | relies_on=[lib.cognitive_learner, lib.exposure_tracker, lib.outcome_log, lib.skills_router]
...
lib/implicit_outcome_tracker.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.advisory_engine_alpha] | relies_on=[lib.diagnostics, lib.file_lock]
...
lib/jsonl_utils.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.advisory_engine_alpha, lib.noise_classifier, lib.runtime_quarantine, scripts.advisory_spine_parity_gate, scripts.memory_json_consumer_gate, scripts.memory_spine_parity_gate] | relies_on=[none]
...
lib/llm.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.bridge_cycle, lib.eidos_refiner, lib.llm_dispatch, lib.meta_ralph, scripts.test_advisory, scripts.test_llm] | relies_on=[lib.advisory_synthesizer, lib.config_authority, lib.diagnostics, lib.queue]
...
lib/memory_banks.py - needs-migration
  - Issues: circular_dependency, lint_top:I001:2,F401:1
  - Migration needed: yes
  - Priority: high
  - Dependencies: relied_by=[lib.advisor, lib.advisory_engine_alpha, lib.bridge, lib.memory_capture, lib.memory_migrate, lib.mind_bridge] | relies_on=[lib.cognitive_learner, lib.config_authority, lib.memory_store, lib.queue, lib.spark_emotions, lib.tuneables_reload]
...
lib/meta_ralph.py - degraded
  - Issues: oversized:2875, long_func:291, circular_dependency, lint_top:I001:1
  - Migration needed: yes
  - Priority: high
...
lib/outcome_checkin.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.bridge, lib.context_sync, lib.memory_capture] | relies_on=[lib.diagnostics]
...
lib/promoter.py - needs-migration
  - Issues: circular_dependency
  - Migration needed: yes
  - Priority: high
  - Dependencies: relied_by=[lib.advisor, lib.auto_promote, lib.bridge, lib.context_sync, lib.eidos.store, lib.meta_ralph] | relies_on=[lib.chip_merger, lib.cognitive_learner, lib.config_authority, lib.llm_area_prompts, lib.llm_dispatch, lib.noise_classifier]
lib/queue.py - degraded
  - Issues: lint_issues:16, lint_top:W293:13,I001:1,F401:1
  - Migration needed: no
  - Priority: medium
  - Dependencies: relied_by=[lib.bridge, lib.bridge_cycle, lib.chip_merger, lib.context_sync, lib.doctor, lib.exposure_tracker] | relies_on=[lib.config_authority, lib.diagnostics, lib.tuneables_reload]
...
lib/runtime_session_state.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[lib.advisory_engine_alpha, lib.advisory_gate, lib.bridge_cycle, scripts.verify_advisory_emissions, tests.test_advisory_calibration, tests.test_advisory_engine_alpha] | relies_on=[lib.config_authority, lib.diagnostics, lib.tuneables_reload]
...
lib/semantic_retriever.py - degraded
  - Issues: long_func:221, circular_dependency, lint_top:I001:1,F401:1
  - Migration needed: yes
  - Priority: high
  - Dependencies: relied_by=[lib.advisor, lib.cognitive_learner, lib.semantic_index, scripts.semantic_eval, scripts.semantic_harness, tests.test_advisor_retrieval_routing] | relies_on=[lib.cognitive_learner, lib.config_authority, lib.diagnostics, lib.embeddings, lib.meta_ralph, lib.tuneables_reload]
...
lib/validate_and_store.py - needs-migration
  - Issues: circular_dependency, lint_top:I001:2
  - Migration needed: yes
  - Priority: high
  - Dependencies: relied_by=[lib.chip_merger, lib.cognitive_signals, lib.curiosity_engine, lib.feedback_loop, lib.hypothesis_tracker, lib.learning_systems_bridge] | relies_on=[lib.cognitive_learner, lib.config_authority, lib.diagnostics, lib.meta_ralph, lib.runtime_quarantine, lib.tuneables_reload]
...
scripts/alpha_preflight_bundle.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[scripts.alpha_intelligence_flow_status] | relies_on=[lib.integration_status, lib.production_gates, lib.service_control]
...
scripts/watchdog.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[tests.test_workflow_fidelity_observatory] | relies_on=[none]
...
spark/cli.py - degraded
  - Issues: lint_density:104, oversized:3799, lint_top:W293:42,F541:38,F401:12
  - Migration needed: no
  - Priority: high
...
tests/test_workflow_fidelity_observatory.py - healthy
  ...
  - Migration needed: no
  - Priority: low
  - Dependencies: relied_by=[none] | relies_on=[scripts.watchdog]
